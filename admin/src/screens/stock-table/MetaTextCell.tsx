...
import type { MetaField } from '@/hooks/useSetMeta';
...
export function MetaTextCell( {
	...
	function handleSet() {
		...
		mutation.mutate(
			{ productId, productName, field, value: trimmed },
					...
					>
						...
						>
							<input
								...
								aria-label={ `New ${ label } for ${ productName }` }
							/>
							<button
								type="button"
								onClick={ handleSet }
